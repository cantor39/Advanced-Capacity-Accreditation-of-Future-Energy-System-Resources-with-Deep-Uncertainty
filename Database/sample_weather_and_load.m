...
weather_year_column = randi([1,403])+6;
weather_year = mod((weather_year_column-7), 31) + 1993;
...
for t=1:Num_Hour
    ...
    hourly_load(t) = 0.5*(sampled_forceasted_load_data(t) + load_adjustment); %0.5 for testing purposes
